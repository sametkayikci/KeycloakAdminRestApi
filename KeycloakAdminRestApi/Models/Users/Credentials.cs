...
public record Credentials
{
    ...
    [JsonPropertyName("config")] public IDictionary<string, string>? Config { get; set; }
    ...
    [JsonPropertyName("hashIterations")] public int? HashIterations { get; set; }
    [JsonPropertyName("hashSaltedValue")] public string? HashSaltedValue { get; set; }
